...
/// "持有股票" tab: currently a placeholder — no holdings endpoint is wired
/// up yet.
final class HoldingsViewController: UIViewController {

    private let titleLabel = UILabel()
    private let placeholderIcon = UIImageView(image: UIImage(systemName: "briefcase"))
    ...
    private func setUpLayout() {
        ...
        placeholderLabel.text = "尚未串接持有股票資料"
